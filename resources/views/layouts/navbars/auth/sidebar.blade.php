  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Perfiles</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('user-profile') ? 'active' : '') }} " href="{{ url('user-profile') }}">
          ...
          <span class="nav-link-text ms-1">Usuario Estandar</span>
        </a>
      </li>
      @role('admin')
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('users') ? 'active' : '') }}" href="{{ url('users') }}">
          ...
          <span class="nav-link-text ms-1">Usuario Administrador</span>
        </a>
      </li>
      @endrole
      <li class="nav-item mt-2">
      ...
      @hasanyrole('admin|punto')
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('metodo-recarga') ? 'active' : '') }}" href="{{ url('metodo-recarga') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      @endhasanyrole
      @hasanyrole('admin|aliado') <!-- Agrega los roles permitidos aquí -->
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('finanzas') ? 'active' : '') }}" href="{{ url('finanzas') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      @hasanyrole('admin')
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('agregar') ? 'active' : '') }}" href="{{ url('agregar') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      @hasanyrole('admin')
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('lista-productos') ? 'active' : '') }}" href="{{ url('lista-productos') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
